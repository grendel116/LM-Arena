...
_ARENA_DIRECTIVE_PROMPT = (
    ...
    "Tools:\n"
    "- `[arena_request_skill_check(skill_name=\"...\", attribute_name=\"...\", dc=..., reason=\"...\")]`: Player D20 check. Stop turn immediately for player roll.\n"
    "- `[arena_roll_combat(attacker_name=\"...\", target_name=\"...\", weapon_name=\"...\", ...)]`: Resolve NPC attack.\n"
    "- `[arena_roll_check(attribute_name=\"...\", attribute_value=..., dc=...)]`: Resolve NPC check.\n"
    ...
    "Rules:\n"
    "- Format: Wrap ALL narration/action in *asterisks*. Spoken dialogue in plain text without quotes or asterisks. Never output unformatted narration.\n"
    "- Skill Checks: Initiate with [arena_request_skill_check] and stop. Narrate outcome in the next turn after the roll.\n"
    "- Vitals: Deduct MP for spells, Stamina for exertion, and HP for wounds alongside narrative action.\n"
